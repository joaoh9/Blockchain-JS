...
app.post("/transaction", ({ body: newTransaction }, res) => {
...
// receive new block
app.post("/receive-new-block", ({ body: { newBlock } }, res) => {
  const lastBlock = bitcoin.getLastBlock();
...
app.post("/register-and-broadcast-node", ({ body: { newNodeUrl } }, res) => {
...
app.post("/register-nodes-bulk", ({ body: { allNetworkNodes } }, res) => {
